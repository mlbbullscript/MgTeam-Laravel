...
@section('title', 'Unggah Transaksi Rekan')
...
<div class="max-w-2xl mx-auto space-y-6">
    ...
    <div class="flex items-center gap-4">
        ...
        <div>
            <h1 class="text-2xl font-bold text-gray-900 tracking-tight">Unggah Transaksi Keuangan</h1>
            <p class="mt-1 text-sm text-gray-500">Laporkan transaksi pemasukan atau pengeluaran operasional kepada tim.</p>
        </div>
    </div>

    {{-- Form Card --}}
    <div class="rounded-xl border border-gray-200 bg-white shadow-sm p-6 sm:p-8">
        <form action="{{ route('rekan.laporan.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            @csrf
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <div class="mt-1">
                        <input type="date" 
                               name="report_date" 
                               id="report_date" 
                               value="{{ old('report_date', today()->toDateString()) }}"
                ...
                <div class="sm:col-span-2">
                    ...
                    <div class="mt-1">
                        <input type="text" 
                               ...
                               placeholder="Contoh: Beli Bahan Baku Kue, Pemasukan Penjualan Offline"
                               required>
                    </div>
                    @error('name')
                        <p class="mt-2 text-sm text-red-600 font-medium">{{ $message }}</p>
                ...
                <div class="sm:col-span-2">
                    ...
                    <div class="mt-1">
                        <textarea name="description" 
                                  ...
                                  placeholder="Catatan kecil detail transaksi..."></textarea>
                    </div>
                    @error('description')
                        <p class="mt-2 text-sm text-red-600 font-medium">{{ $message }}</p>
                    @enderror
                ...
                <div class="sm:col-span-2" x-data="{ fileName: null, filePreview: null }">
