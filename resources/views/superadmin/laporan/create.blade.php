...
<div class="max-w-2xl mx-auto space-y-6">
    ...
    <div class="flex items-center gap-4">
        ...
        <div>
            <h1 class="text-2xl font-bold text-gray-900 tracking-tight">Catat Transaksi Keuangan</h1>
            <p class="mt-1 text-sm text-gray-500">Catat detail pemasukan atau pengeluaran kas operasional bisnis.</p>
        </div>
    </div>

    {{-- Form Card --}}
    <div class="rounded-xl border border-gray-200 bg-white shadow-sm p-6 sm:p-8">
        <form action="{{ route('superadmin.laporan.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            @csrf
                ...
                <div class="sm:col-span-2">
                    ...
                    <div class="mt-1">
                        <textarea name="description" 
                                  ...
                                  placeholder="Catatan kecil pendukung transaksi kas..."></textarea>
                    </div>
                    @error('description')
                        <p class="mt-2 text-sm text-red-600 font-medium">{{ $message }}</p>
                    @enderror
                                   ...
                                   @change="
                                       ...
                                       if (file) {
                                           ...
                                           if (file.type.startsWith('image/')) {
                                               ...
                                               filePreview = null; // No preview for PDF
                                           }
                                       }
                                   ">
                            <button type="button" 
